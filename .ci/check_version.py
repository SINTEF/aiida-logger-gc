...
Check version number in setup.json and aiida_logger/__init__.py and make sure
they match.
"""
...
import aiida_logger  # pylint: disable=wrong-import-position
version = aiida_logger.__version__
